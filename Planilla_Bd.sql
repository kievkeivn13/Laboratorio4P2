...
use Planilla_Bd;
create table departamento_17632
(
...
puesto_17632(codigo_puesto),
foreign key (codigo_departamento) references
departamento_17632(codigo_departamento)

)engine=InnoDB;

create table nominae_17632
(
